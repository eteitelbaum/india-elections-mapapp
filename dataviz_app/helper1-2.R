...
states_72_00 <- st_read(dsn ="../shapefiles/state_maps.gpkg", layer = "states_1972_2000") %>%
  rename(state_name = ST_NM) 

states_00_14 <- st_read(dsn ="../shapefiles/state_maps.gpkg", layer = "states_2000_2014") %>%
  rename(state_name = ST_NM) 

states_14_19 <- st_read(dsn ="../shapefiles/state_maps.gpkg", layer = "states_2014_2019") %>%
  rename(state_name = ST_NM) 
